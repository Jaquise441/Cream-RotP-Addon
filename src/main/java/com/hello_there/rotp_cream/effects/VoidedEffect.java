...
public class VoidedEffect extends UncurableEffect {
    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        if (!entity.level.isClientSide()) {
            ...
            entity.addEffect(new EffectInstance(ModStatusEffects.FULL_INVISIBILITY.get(), duration, 1, false, false));
            entity.addEffect(new EffectInstance(Effects.INVISIBILITY, duration, 1, false, false));
            entity.addEffect(new EffectInstance(Effects.MOVEMENT_SPEED, duration, 6, false, false));
            entity.addEffect(new EffectInstance(Effects.BLINDNESS, duration, 1, false, false));
            entity.addEffect(new EffectInstance(InitEffects.TRUE_BLINDNESS.get(), duration, 1, false, false));
